# Mathematics Pupil’s Book Standard Three — ADT Bundle Reference
...
**Mathematics Pupil’s Book Standard Three** — This is an English-language Mathematics Pupil’s Book for Standard Three (roughly Grade 3 primary level) published by the Tanzania Institute of Education for use in Tanzania. It introduces foundational numeracy and geometry topics such as whole numbers, addition and subtraction, measurement, shapes, fractions, time, and Tanzanian currency, with many worked examples, exercises, and everyday local contexts. The book follows a competency-based, activity-oriented approach that emphasizes practical problem-solving, reading and writing numbers, and applying mathematics to real-life situations.
...
```
MATHEMATICS-STD-III-PB--SEPT-2025-/
├── adt/                              # THE WEB APP
...
├── MATHEMATICS-STD-III-PB--SEPT-2025-.db                    # SQLite database (pipeline state)
├── MATHEMATICS-STD-III-PB--SEPT-2025-.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval from the United Republic of Tanzania Ministry of Education, Science and Technology for Mathematics Pupil’s Book Standard Three, approval No. 1222, issued to Tanzania Institute of Education.",
  "qz001_que": "In the number 5463, which digit is in the hundreds place?",
  "qz001_o0": "1) 3",
  "qz001_o0_exp": "❌ Not quite. The digit 3 is in the ones place, not the hundreds place."
}
```
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">In the number 5463, which digit is in the hundreds place?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Not quite. The digit 3 is in the ones place, not the hundreds place." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) 3</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `MATHEMATICS-STD-III-PB--SEPT-2025-.pdf` |
| Pipeline database | `MATHEMATICS-STD-III-PB--SEPT-2025-.db` (SQLite) |
